...
public enum ErrorMessage {
    ...
    TWO_GROUPS_NEEDED("Combination Questions need to have two groups."),
    ONE_CORRECT_OPTION_NEEDED("Questions need to have at least 1 correct option"),
    NO_CORRECT_ANSWER("Question does not have a correct answer defined"),
    ...
    RELEVANCE_ONLY_WITH_CORRECT_OPTION("Cannot set relevance on wrong option"),
    RELEVANCE_ONLY_WITH_MULTIPLE_SELECTION("Can only set Relevance with at least two correct options"),
    ALL_CORRECT_OPTIONS_RELEVANCE("Relevance must be aplied for all correct options");

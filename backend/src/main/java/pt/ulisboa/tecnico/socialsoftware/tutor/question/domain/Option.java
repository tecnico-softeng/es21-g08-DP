...
import static pt.ulisboa.tecnico.socialsoftware.tutor.exceptions.ErrorMessage.RELEVANCE_ONLY_WITH_CORRECT_OPTION;
...
public class Option implements DomainEntity {
    ...
    public Option(OptionDto option) {
        ...
        if (option.getRelevance() != null) setRelevance(option.getRelevance());      //NOVO   
    }
    ...
    public void setRelevance(Integer relevance) {                       //NOVO
        if (relevance < 0)

...
public interface Visitor {
    ...
    default void visitAnswerDetails(CombinationAnswer answer){}

    default void visitQuestionDetails(CombinationQuestion combinationQuestion) {}

    default void visitCombinationGroups(CombinationGroup combinationGroup) {}

    default void visitCombinationItem(CombinationItem item) {}
  
    default void visitQuestionDetails(OpenEndedQuestion answer) {}

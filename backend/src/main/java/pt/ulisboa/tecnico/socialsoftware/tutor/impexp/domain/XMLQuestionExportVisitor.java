...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    @Override
    public void visitQuestionDetails(CombinationQuestion question) {
        ...
        Element spotsElement = new Element("combinationGroup");
        this.currentElement.addContent(spotsElement);

        this.currentElement = spotsElement;
        question.visitCombinationGroups(this);
    }

    @Override
    public void visitCombinationGroups(CombinationGroup group) {
        Element spotElement = new Element("combinationGroup");

        spotElement.setAttribute("sequence", String.valueOf(group.getSequence()));
        this.currentElement.addContent(spotElement);
        var oldElement = this.currentElement;
        this.currentElement = spotElement;

        group.visitOptions(this);
    ...
    public void visitCombinationItem(CombinationItem item) {
        Element optionElement = new Element("combinationItem");

        optionElement.setAttribute("sequence", String.valueOf(item.getSequence()));
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        ...
        Element correctAnswer = new Element("defaultCorrectAnswer");
        correctAnswer.addContent(question.getCorrectAnswerRepresentation());

        this.currentElement.addContent(correctAnswer);
    }
}

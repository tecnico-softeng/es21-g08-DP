...
class SpockTest extends Specification {
    ...
    public static final String OPEN_ENDED_QUESTION_1_ANSWER = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi rutrum purus ex, eu semper orci interdum nec."
    public static final String OPEN_ENDED_QUESTION_2_ANSWER = "Just another one."
    public static final String OPEN_ENDED_BAD_XML = System.getProperty("user.dir") + "/src/test/resources/badOpenEndedQuestion.xml"
    ...
    public static final List LIST_1_COMBINATION = []
    public static final List LIST_2_COMBINATION = []

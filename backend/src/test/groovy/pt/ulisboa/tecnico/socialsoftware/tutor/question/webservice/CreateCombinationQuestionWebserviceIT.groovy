...
import pt.ulisboa.tecnico.socialsoftware.tutor.exceptions.CustomExceptionHandler
...
class CreateCombinationQuestionWebServiceIT extends SpockTest {
    @LocalServerPort
    private int port
    ...
    def "create combination question by teacher"() {
        ...
        response != null
        response.status == 200
        and: "if it responds with the correct question created"
    ...
    def "cannot create combination question by student"() {
